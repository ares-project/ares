...
!define HELPURL "https://github.com/ares-project/ares/issues"
!define UPDATEURL "https://github.com/ares-project/ares/releases"
!define ABOUTURL "https://github.com/ares-project/ares#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:13990)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:13990)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:13990)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:13990)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 13990 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:13990)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 13990 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:13990)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 13990 "" ""
